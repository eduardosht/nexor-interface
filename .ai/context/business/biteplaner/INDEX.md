...
- `product-flow.md`: fluxo de negócio completo, atores, jornada, status técnicos, formulários, pagamento Pagar.me com split, inaptidão, rastreabilidade e regras de interface.
...
- Se estiver apto, a ordem vai para pagamento do cliente via checkout Pagar.me com split quando houver dentista e laboratório vinculados.
...
- A confirmação de pagamento vem do webhook Pagar.me; `/painel/compra?checkout=success` é apenas feedback visual pós-redirecionamento.
