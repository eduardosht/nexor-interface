        ...
        orders: [
          {
            ...
            productionRequestDraft: {
              ...
              scan3dFileRef: {
                ...
                objectKey: 'biteplaner/production-scans/BP-DEMO-005/upload_demo_marina_scan/marina-demo-arcada-superior.stl',
        ...
        return Promise.resolve({
          ...
          payload: {
            ...
            scan3dFileRef: {
              ...
              provider: 'amazon-s3',
              purpose: 'production_scan3d',
              objectKey: 'biteplaner/production-scans/BP-DEMO-088/upload_demo_scan_123/scan-real.stl',
              mimeType: 'model/stl',
              sizeBytes: 123456,
              scanStatus: 'not_scanned',
