...
export const DEMO_PERSONA_LABELS: Record<DemoPersona, string> = {
  ...
  athlete: 'Atleta',
  athletePrerequisite: 'Cliente - Pré-consulta',
  athleteScheduling: 'Cliente - Selecionar clínica',
  athletePreConsultation: 'Cliente - Pré-consulta clínica',
  athleteClinicalDecision: 'Cliente - Decisão clínica',
