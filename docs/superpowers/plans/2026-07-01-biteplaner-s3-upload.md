  ...
  it('requires S3 bucket and AWS region in production', () => {
    expect(() =>
      loadEnv({
        ...
        PAGARME_SECRET_KEY: 'sk_live_test',
        PAGARME_BASE_URL: 'https://sdx-api.pagar.me/core/v5',
        PAGARME_BITEPLANER_AMOUNT_CENTS: '100000',
        PAGARME_BITEPLANER_SPLIT_SETTINGS_JSON: '{"rules":[{"recipient_id":"rp_dentist","type":"percentage","amount":6000}]}',
